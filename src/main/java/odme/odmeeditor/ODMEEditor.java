...
//      -------------------------------------
        ...
        scenarioDistribution.setBorder(new EtchedBorder());
...
//      -------------------------------------
        ...
        scenarioInterEntityConstraints.setBorder(new EtchedBorder());
        ...
        scenarioIntraEntityConstraint.setBorder(new EtchedBorder());
...
//    -------------------------------------
        ...
        splitPane = panelSplitor.addSplitor(projectPanel, treePanel, graphWindow,
        			console, scenarioVariable, scenarioDistribution, scenarioBehaviour, scenarioInterEntityConstraints, scenarioIntraEntityConstraint, tabbedPane);
    ...
    public static void updateState() {
        ...
        JtreeToGraphConvert.rootToEndNodeDistribution();
        JtreeToGraphConvert.rootToEndNodeIntraConstraint();
        JtreeToGraphConvert.rootToEndNodeInterConstraint();
