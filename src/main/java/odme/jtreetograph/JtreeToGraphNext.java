...
//                	JtreeToGraphConvert.rootToEndConstraintAddition(targetCell2); // constraint addition
    ...
    public static void nextChildNodeForDistribution(mxCell cell) {
        Object[] outgoing = graph.getOutgoingEdges(cell);
        ...
        if (outgoing.length > 0) {
            for (int i = 0; i < outgoing.length; i++) {
                ...
                if (targetCell2.getId().startsWith("uniformity")) {
                    ...
                    JtreeToGraphConvert.rootToEndDistributionAddition(targetCell2);
                    nextChildNodeForDistribution(targetCell2);
                }
    ...
    public static void nextChildNodeForIntraConstraint(mxCell cell) {
        Object[] outgoing = graph.getOutgoingEdges(cell);
        ...
        if (outgoing.length > 0) {
            for (int i = 0; i < outgoing.length; i++) {
                ...
                if (targetCell2.getId().startsWith("uniformity")) {
                    ...
                    JtreeToGraphConvert.rootToEndIntraConstraintAddition(targetCell2);
                    nextChildNodeForIntraConstraint(targetCell2);
                }
    ...
    public static void nextChildNodeForInterConstraint(mxCell cell) {
        Object[] outgoing = graph.getOutgoingEdges(cell);
        ...
        if (outgoing.length > 0) {
            for (int i = 0; i < outgoing.length; i++) {
                ...
                if (targetCell2.getId().startsWith("uniformity")) {
                    ...
                    JtreeToGraphConvert.rootToEndInterConstraintAddition(targetCell2);
                    nextChildNodeForInterConstraint(targetCell2);
                }
